    ...
    @else
        <form method="POST" action="{{ route('checkin.store') }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="number" id="weight" name="weight" step="0.1" class="text-black">
                @error('weight')
                    <span>{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" id="sleep_quality" name="sleep_quality" min="1" max="10" class="text-black">
                @error('sleep_quality')
                    <span>{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" id="training_quality" name="training_quality" min="1" max="10" class="text-black">
            ...
            <div>
                ...
                <input type="number" id="soreness" name="soreness" min="1" max="10" class="text-black">
                @error('soreness')
                    <span>{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" id="food_quality" name="food_quality" min="1" max="10" class="text-black">
                @error('food_quality')
                    <span>{{ $message }}</span>
                @enderror
            </div>
